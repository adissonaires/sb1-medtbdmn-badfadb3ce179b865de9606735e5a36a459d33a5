  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        showNotification('Failed to create dealership', 'error');
        return;
      }
      ...
      await supabase
        ...
        .insert({
          ...
          record_id: data.id,
          details: `Created dealership: ${formData.name}`,
          created_at: new Date().toISOString()
        });
      
      showNotification('Dealership created successfully', 'success');
      ...
      console.error('Exception creating dealership:', error);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Add New Dealership</Text>
      </View>
        ...
        >
          {isSubmitting ? (
            ...
            <>
              ...
              <Text style={styles.submitButtonText}>Create Dealership</Text>
            </>
          )}
        </TouchableOpacity>
      </ScrollView>
